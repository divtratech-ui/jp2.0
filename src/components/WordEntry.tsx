...
const WordEntry = ({ word, reading, meanings, examples }: WordEntryProps) => {
    ...
    <div className="border border-border rounded-lg p-4 space-y-3">
      ...
      {showAi && (
        <>
          ...
          <WordChat word={word} reading={reading} meanings={meanings} />
        </>
      )}
    </div>
  );
