...
const KanaEntry = ({ kana, meanings, examples }: KanaEntryProps) => {
  ...
  return (
    <div className="border border-border rounded-lg p-4 space-y-3">
      <div className="flex items-baseline gap-3">
        <span className="text-4xl font-bold">{kana}</span>
        <ListenButton text={kana} />
      </div>
      ...
      {showAi && (
        <>
          ...
          <WordChat word={kana} meanings={meanings} />
        </>
      )}
    </div>
  );
